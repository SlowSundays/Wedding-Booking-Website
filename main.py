...
def main(page: ft.Page) -> None:
    ...
    checkbox_signup: Checkbox = Checkbox(label='I definitely agree to all of this', value=False)
    ...
    page.add(
        Row(
            controls=[
                Column(
                    controls=[text_username, text_password, checkbox_signup, button_submit],
                    alignment=ft.MainAxisAlignment.CENTER
                )
            ],
            alignment=ft.MainAxisAlignment.CENTER
